const createRetryConsumer = require('../retryConsumer');
...
const runRetryConsumer = async (consumerName) => {
  await createRetryConsumer('retry2m-group', consumerName, async ({ message }) => {
    try {
...
module.exports = runRetryConsumer;
